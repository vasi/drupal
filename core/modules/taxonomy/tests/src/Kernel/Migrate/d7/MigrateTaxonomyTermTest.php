...
class MigrateTaxonomyTermTest extends MigrateDrupal7TestBase {
  ...
  protected function assertHierarchy($vid, $tid, array $parent_ids) {
    ...
    $this->assertArrayHasKey($tid, $this->treeData[$vid],
      "Term $tid exists in taxonomy tree");
    $term = $this->treeData[$vid][$tid];
    $this->assertEquals($parent_ids, array_filter($term->parents),
      "Term $tid has correct parents in taxonomy tree");
  }
